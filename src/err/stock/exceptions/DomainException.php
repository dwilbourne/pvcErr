 ...
 *
 *        function __construct($color_arg, Throwable $previousException) {
 *            $s = "%s is not a primary color.";
 *            $msg = sprintf($s, json_encode($color_arg));
 *            return new pvc\DomainException($msg, $previousException);
 *        }
 *    }
 *
 *    $s = "turtle";
...
class DomainException extends Exception
{
    public function __construct(Msg $msg, Throwable $previous = null)
    {
        ...
        $this->code = ExceptionConstants::DOMAIN_EXCEPTION;
    }
}
