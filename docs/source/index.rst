...
* Testing of an exception library is almost entirely autogenerated.  You write one boilerplate test for each library and get thorough testing and 100% code coverage.
